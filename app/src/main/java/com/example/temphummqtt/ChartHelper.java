...
public class ChartHelper implements OnChartValueSelectedListener {
    ...
    public ChartHelper(LineChart chart,int cl) {
        mChart = chart;
    ...
    public void addEntry(float value,int cl,String title) {
    ...
    private LineDataSet createSet(int cl,String title) {
        ...
        set.setFillAlpha(65);
        set.setFillColor(cl);
        set.setHighLightColor(cl);
        set.setValueTextColor(cl);
