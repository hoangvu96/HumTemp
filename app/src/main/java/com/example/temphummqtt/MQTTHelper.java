...
public class MQTTHelper {
    ...
    public MQTTHelper(final Context context) throws MqttException {
        ...
        mqttAndroidClient = new MqttAndroidClient(context, Constan.HOST, MqttClient.generateClientId());
    ...
    private void connect() throws MqttException {
        ...
        mqttConnectOptions.setUserName(Constan.USERNAME);
        mqttConnectOptions.setPassword(Constan.PASSWORD.toCharArray());
